...
export const tiffToJpgContent: Record<ToolLocale, ResizeImageContent> = {
  ja: {
    page: {
      title: "TIFF to JPG",
      description: "TIFF画像をJPG形式に変換できる無料ツールです。",
      aboutTitle: "TIFF to JPGとは？",
      aboutText:
        "TIFF画像をJPG形式へ変換できる無料ツールです。JPGは共有しやすく、ファイルサイズも軽くなりやすい形式です。",
      stepsTitle: "使い方",
      steps: [
        "TIFF画像をアップロードします",
      ...
      faqs: [
        {
          question: "TIFFをJPGにするメリットは？",
          answer:
            "JPGはTIFFよりファイルサイズが小さくなりやすく、共有や保存に向いています。",
        },
        {
          question: "安全ですか？",
          answer:
      ...
      relatedTools: [
        { name: "TIFF to PNG", href: "/tools/tiff-to-png" },
    ...
    ui: {
      ...
      invalidFileError: "エラー: TIFF画像を選択してください",
      validationNoSize: "",
  ...
  en: {
    page: {
      title: "TIFF to JPG",
      description: "Convert TIFF images to JPG format online for free.",
      aboutTitle: "What is TIFF to JPG?",
      aboutText:
        "This free tool converts TIFF images into JPG format. JPG is easier to share and often results in smaller file sizes.",
      ...
      faqs: [
        {
          ...
          answer:
            "JPG often creates smaller file sizes than TIFF, making it more suitable for sharing and storage.",
        },
        {
    ...
    ui: {
      emptyTitle: "Drag and drop a TIFF image",
      ...
      invalidFileError: "Error: Please select a TIFF image",
      validationNoSize: "",
      validationInvalidSize: "",
      validationInvalidResultSize: "",
