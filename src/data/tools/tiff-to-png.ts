...
export const tiffToPngContent: Record<ToolLocale, ResizeImageContent> = {
  ja: {
    page: {
      title: "TIFF to PNG",
      description: "TIFF画像をPNG形式に変換できる無料ツールです。",
      aboutTitle: "TIFF to PNGとは？",
      aboutText:
        "TIFF画像をPNG形式へ変換できる無料ツールです。PNGは扱いやすく、画質を保ちやすい形式です。",
      stepsTitle: "使い方",
      steps: [
        "TIFF画像をアップロードします",
      ...
      faqs: [
        {
          question: "TIFFをPNGにするメリットは？",
          answer:
            "PNGは多くの環境で扱いやすく、Webや一般的な画像利用に向いています。",
        },
        {
          question: "安全ですか？",
          answer:
      ...
      relatedTools: [
        { name: "TIFF to JPG", href: "/tools/tiff-to-jpg" },
  ...
  en: {
    page: {
      title: "TIFF to PNG",
      description: "Convert TIFF images to PNG format online for free.",
      aboutTitle: "What is TIFF to PNG?",
      aboutText:
        "This free tool converts TIFF images into PNG format. PNG is easier to handle and helps preserve image quality.",
      ...
      faqs: [
        {
          ...
          answer:
            "PNG is easier to use in many environments and is suitable for web and general image use.",
        },
        {
