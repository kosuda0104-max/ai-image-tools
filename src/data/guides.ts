...
const jaGuides: GuideEntry[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "JPG・JPEGをPNGに変換するだけでは透過にならない",
        paragraphs: [
          "JPGをPNGに変換しても、白い背景は白いままです。変換で保存形式は変わりますが、背景を自動で見分けて消す処理は行われません。",
          "背景を透明にしたい場合は、まず背景透明化ツールで白や単色の背景を選んで消し、透過PNGとして保存します。単に編集しやすいPNGへ変えたいだけなら、JPGからPNGへの変換ツールを使えます。",
        ],
      },
      {
