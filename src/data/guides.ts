    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "当サイトはスマホ表示に最適化されており、55種類のツールがすべて無料で使えます。よく使うツールをホーム画面に追加しておくと、アプリ感覚で呼び出せて便利です。",
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Filewisp is optimized for mobile, with 55 free tools. Add your most-used ones to the home screen and they behave like apps.",
        ],
      },
    ],
  },
