...
const guideToolMap: Record<string, string[]> = {
  ...
  "parquet-csv-workflows": ["parquet-to-csv", "parquet-to-excel", "csv-to-parquet"],
  ...
  "csv-encoding-fix": ["csv-encoding-fix", "csv-to-json", "json-to-csv", "csv-to-parquet"],
  "what-is-parquet": ["parquet-to-csv", "parquet-to-excel", "csv-to-parquet", "json-to-csv"],
  "json-and-csv": ["json-to-csv", "json-to-excel", "csv-to-json", "csv-to-parquet"],
