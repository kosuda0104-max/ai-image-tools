...
const guideToolMap: Record<string, string[]> = {
  ...
  "parquet-csv-workflows": ["parquet-viewer", "parquet-to-csv", "parquet-to-excel", "csv-to-parquet", "s3-inventory-viewer", "cloudtrail-log-to-csv"],
  ...
  "what-is-parquet": ["parquet-viewer", "parquet-to-csv", "parquet-to-excel", "csv-to-parquet", "s3-inventory-viewer"],
