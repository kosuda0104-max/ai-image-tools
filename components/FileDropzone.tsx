        ...
        {file ? (
          ...
          <>
            ...
            <div className="text-center">
              ...
              <p className="mt-1 text-xs text-teal-600 underline underline-offset-2">{changeFileLabel}</p>
            </div>
          </>
        ) : (
          /* Empty state */
          <>
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gray-200 text-gray-500 group-hover:bg-teal-100 group-hover:text-teal-600 transition-colors">
            ...
            <span className="rounded-lg bg-gray-900 px-4 py-2 text-sm font-medium text-white group-hover:bg-teal-600 transition-colors">
