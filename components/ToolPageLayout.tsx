    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 py-6 sm:py-8">
        <div className="space-y-8 sm:space-y-10">
          ...
          <section className="rounded-xl border border-gray-200 bg-gray-50 p-4 sm:rounded-2xl sm:p-6">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                {workflowSuggestions.map((tool) => (
                  <Link
                    key={tool.href}
                    href={tool.href}
                    className="group rounded-xl border border-gray-200 bg-white p-4 transition duration-200 hover:-translate-y-0.5 hover:border-transparent hover:shadow-lg hover:shadow-gray-200/70 sm:rounded-2xl sm:p-5"
                  >
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              {faqs.map((faq, index) => (
                <div key={index} className="rounded-xl border border-gray-200 bg-white p-4 sm:rounded-2xl sm:p-5">
          ...
          <section className="rounded-xl border border-gray-200 bg-gray-50 p-4 sm:rounded-2xl sm:p-6">
            <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
              ...
              <Link
                href={guidesPath}
                className="w-full shrink-0 rounded-xl bg-gray-900 px-4 py-2.5 text-center text-sm font-medium text-white transition hover:bg-gray-700 sm:w-auto"
              >
