...
import { flipImageContent } from "@/src/data/tools/flip-image";

const locale = "ja";
const t = flipImageContent[locale];
      ...
      img.onload = () => {
        ...
        canvas.toBlob(
          (blob) => {
            ...
            link.download = `${baseName}-flipped.${outputExt}`;
            link.click();
  ...
  return (
    ...
    >
      <div className="space-y-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <PrimaryButton onClick={handleFlip} disabled={!image || isProcessing}>
