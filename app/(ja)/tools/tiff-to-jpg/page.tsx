...
import { tiffToJpgContent } from "@/src/data/tools/tiff-to-jpg";

const locale = "ja";
const t = tiffToJpgContent[locale];
      ...
      img.onload = () => {
        ...
        canvas.toBlob(
          (blob) => {
            ...
            const baseName = image.name.replace(/\.(tif|tiff)$/i, "");
      ...
      <div className="space-y-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <FileDropzone
          ...
          onFileSelect={(file) => {
            ...
            const isTiff =
              file.type === "image/tiff" || /\.(tif|tiff)$/i.test(file.name);
