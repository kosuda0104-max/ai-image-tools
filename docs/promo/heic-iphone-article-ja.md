...
![iPhoneのHEICはそのままだとPCで開けないが、JPGに変換すればどこでも開ける](./assets/heic-explainer.png)
<!-- 📌 投稿時：assets/heic-explainer.png をQiita/Zennにアップロードして差し替え（PNG化済み・そのまま使用可） -->

## 何が起きるか

![Windowsで .heic を開こうとすると「このファイルは開けません」と表示される](./assets/heic-error-windows.png)
...
![iPhoneの設定→カメラ→フォーマットで「互換性優先」を選ぶ](./assets/iphone-camera-format.png)
...
![Filewispでの変換3ステップ：ドロップ→形式を選ぶ→ダウンロード](./assets/filewisp-convert-steps.png)
